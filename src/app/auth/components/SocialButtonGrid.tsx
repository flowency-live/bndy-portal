...
export function SocialButtonGrid({
  ...
  return (
    <div className={`grid grid-cols-3 gap-3 ${className}`} data-testid={testId}>
      {providers.map((provider) => (
        <button
          ...
          className={`
            flex items-center justify-center px-3 py-3 border border-slate-600 rounded-xl text-white hover:bg-slate-700 transition-colors group
